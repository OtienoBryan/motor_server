...
const getDatabaseConfig = (configService) => ({
    ...
    entities: [entities_1.Staff, entities_1.Department, entities_1.ChatRoom, entities_1.ChatMessage, entities_1.Notice, entities_1.Country, entities_1.SalesRep, entities_1.Region, entities_1.Route, entities_1.LoginHistory, entities_1.Station, entities_1.FuelPrice, client_entity_1.Client, product_entity_1.Product, category_entity_1.Category, aircraft_entity_1.Aircraft, destination_entity_1.Destination, flight_series_entity_1.FlightSeries, seat_reservation_entity_1.SeatReservation, passenger_entity_1.Passenger, booking_entity_1.Booking, booking_passenger_entity_1.BookingPassenger, client_ledger_entity_1.ClientLedger, sales_order_entity_1.SalesOrder, sales_order_item_entity_1.SalesOrderItem, supplier_entity_1.Supplier, purchase_order_entity_1.PurchaseOrder, purchase_order_item_entity_1.PurchaseOrderItem, task_entity_1.Task, crew_entity_1.Crew, key_account_entity_1.KeyAccount, key_account_ledger_entity_1.KeyAccountLedger, vehicle_entity_1.Vehicle, inventory_ledger_entity_1.InventoryLedger, sale_entity_1.Sale, conversion_entity_1.Conversion],
    synchronize: false,
